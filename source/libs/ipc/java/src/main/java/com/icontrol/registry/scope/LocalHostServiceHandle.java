...
//-----------------------------------------------------------------------------
// Class definition:    LocalHostServiceHandle
/**
 *  ServiceHandle implementation to represent a Service that is
 *  running in a different VM then the ServiceRegistry, and therefore
 *  must marshal/unmarshal data for IPC and Events.
 *  
 *  @author jelderton
 **/
//-----------------------------------------------------------------------------
public class LocalHostServiceHandle extends ServiceHandle
{
    //--------------------------------------------
    /**
     ...
     */
    //--------------------------------------------
    public LocalHostServiceHandle(String name, int ipc, int event)
    {
     ...
     */
    //--------------------------------------------
    public LocalHostServiceHandle(String name, int ipc, int event, Visibility vis)
    {
