...
//-----------------------------------------------------------------------------
// Class definition:    IntegerIPC
/**
 *  ObjectIPC that can be used when the input/output is simply an Integer
 *  
 *  @author jelderton
 **/
//-----------------------------------------------------------------------------
public class IntegerIPC implements ObjectIPC
{
    public static final String MY_KEY = "i";       // do not change.  generated code depends on this
