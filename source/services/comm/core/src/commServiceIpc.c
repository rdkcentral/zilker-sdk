...
IPCCode handle_commService_GET_RUNTIME_STATS_request(bool input, runtimeStatsPojo *output)
{
    ...
    // TODO: gather stats about unsent msg count, pending ack msg count, pending alarm msg count
    // TODO: gather stats about cell received msg (byte count) and cell transmit msg (byte count)
