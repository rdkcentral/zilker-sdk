...
public class GetEndpointIdsRequest extends DeviceRequest
{
    public GetEndpointIdsRequest(int requestId, String eui64)
    {
        super(requestId, eui64, "getEndpointIdsResponse");
    }
    ...
    public void executeDeviceRequest(MockZigbeeDevice device)
    {
        new Response(requestId, 0, responseType) {
            public Integer[] getEndpointIds() { return device.getEndpointIds(); }
        }.send();
    }
}
