...
public class NetworkHealthCheckConfigureRequest extends Request
{
    ...
    public NetworkHealthCheckConfigureRequest(int requestId,
                                              int intervalMillis,
                                              int ccaThreshold,
    ...
    public void execute()
    {
        ...
        MockZigbeeCore.getInstance().networkHealthCheckConfigure(intervalMillis,
                                                                 ccaThreshold,
                                                                 ccaFailureThreshold,
                                                                 restoreThreshold,
                                                                 delayBetweenThresholdRetriesMillis);
    }
}
